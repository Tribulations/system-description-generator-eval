...
from prompts import sdg_task_template, get_task_introduction_prompt, relevance_evaluation_criteria, relevance_evaluation_steps
...
evaluation_steps = relevance_evaluation_steps
